...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM stock");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM stock LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
echo "ID INVALIDE !!";
}
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active" ><a href="stock.php?page=1"><i class="fas fa-database"></i> <span>Stock</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Gestion des stocks</h3>
                            <ul class="breadcrumb">
...
if  (isset($_GET['modif']) && $_GET['modif']=="ok"){
  ...
  Stock de produit modifiee avec success 
  </div>";
}
?>
...
foreach($resultspg as $stock){
    ...
    foreach($produits as $index=>$prod){
      ...
      foreach($produits as $index=>$prod){
        if($stock['produit']==$prod['id_p']){
       echo  "<td><img src="."../img/produits/".$prod['image_p']." width='100px;' ></td>";
      }
      }
 echo   " <td>".$stock['qantite']."</td>
  ...
  echo"
    <td class='text-right'>
    <div class='actions'>
        <a class='btn btn-sm bg-primary-light' data-toggle='modal' data-target='#edit_specialities_details".$stock['id']."'>
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='stock.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='stock.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='stock.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='stock.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
...
foreach($stocks as $index=>$stock){?>
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $stock['id'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Modifier stock produit</h5>
...
<div class="mb-3">
    <input type="hidden" class="form-control"   value="<?php echo $stock['id'] ;?>" name="ids">
    
  </div>
  <div class="mb-3">
    <input type="hidden" placeholder="PRODUIT" class="form-control"  value="<?php echo $stock['produit'] ;?>" name="prod">
  </div>
 
  <div class="mb-3">
    <label   class="form-label">QUANTITE:</label>
    <input type="number" required class="form-control"  value="<?php echo $stock['qantite'] ;?>" name="qtts">
  </div>
