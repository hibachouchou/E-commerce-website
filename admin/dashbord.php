            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Bienvenue <?php echo $_SESSION['nom_admin'];?>!</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item active">Espace admin</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<h3><?php echo $data["abonne"]; ?></h3>
										</div>
									</div>
									<div class="dash-widget-info">
										
										<h6 class="text-muted">Abonnees</h6>
										<div class="progress progress-sm">
							...
							<div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<h3><?php echo $data["panier"]; ?></h3>
										</div>
									</div>
									<div class="dash-widget-info">
										
										<h6 class="text-muted">Paniers</h6>
										<div class="progress progress-sm">
                        ...
                        <div class="card">
								<div class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											<h3><?php echo $data["panier2"]; ?></h3>
										</div>
									</div>
									<div class="dash-widget-info">
										
										<h6 class="text-muted">Delevery</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-warning w-50"></div>
										</div>
									</div>
