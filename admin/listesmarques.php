...
$resultspg->execute();
    ...
    header("location:listesmarques.php?page=1");
}
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active"><a href="listesmarques.php?page=1"><i class="fas fa-paperclip"></i> <span>Les marques</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Liste des marques</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-sm-5 col">
								<a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-success float-right mt-2">Ajouter marque</a>
							</div>
                    </div>
                </div>
					<!-- /Page Header -->
...
?>
                                           ...
                                           <?php
foreach($resultspg as $mq){

    echo " <tr>
    <th scope='row'>".$mq['id_mq']."</th>
    <td>".$mq['nom_mq']."</td>
    <td><img src="."../img/Marque/".$mq['img_mq']." width='100px;' ></td> 
 

    <td class='text-right'>
    <div class='actions'>
        <a class='btn btn-sm bg-primary-light' data-toggle='modal' data-target='#edit_specialities_details".$mq['id_mq']."'>
            <i class='fe fe-pencil'></i> Modifier
        </a>
        <a  data-toggle='modal' href='#delete_modal".$mq['id_mq']."'  class='btn btn-sm bg-danger-light'>
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='listesmarques.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='listesmarques.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='listesmarques.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='listesmarques.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
...
?>
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control"  name="idmq">
    
  </div>
  <div class="mb-3">
    <label  class="form-label">NOM:</label>
    <input type="text" required class="form-control"  name="nommq">
  </div>
  <div class="mb-3">
    <label  class="form-label">IMAGE:</label>
    <input type="file" required class="form-control"  name="imgmq">
  </div>
...
foreach($marque as $mq){?>
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $mq['id_mq'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Modifier marque</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
...
<div class="mb-3">
    <input type="hidden" class="form-control"   value="<?php echo $mq['id_mq'] ;?>" name="idmqm">
    
  </div>
  <div class="mb-3">
    <label  class="form-label">NOM:</label>
    <input type="text" required class="form-control"  value="<?php echo $mq['nom_mq'] ;?>" name="nommqm">
  </div>
  
  <div class="mb-3">
    <label  class="form-label">IMG:</label>
    <input type="file" required class="form-control"  value="<?php echo $mq['img_mq'] ;?>" name="imgmqm">
  </div>
...
foreach($marque as $mq){?>
			<!-- Delete Modal -->
			<div class="modal fade" id="delete_modal<?php echo $mq['id_mq'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<p class="mb-4">Voulez vous vraiment supprimer cette marque ?</p>
								<a href='../marque/supp.php?id=<?php echo  $mq['id_mq']; ?>'><button type="button" class="btn btn-danger" >Supprimer </button></a>
