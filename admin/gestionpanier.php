...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM panier where etat=0");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM panier where etat=0 LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active"><a href="gestionpanier.php?page=1"> <i class='fas fa-shopping-cart'></i> <span>Paniers</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Liste des paniers</h3>
                            <ul class="breadcrumb">
...
foreach($resultspg as $pan){
 ...
 echo "
    ...
    <div class='actions'>
        ...
        <a  data-toggle='modal' href='#delete_modal'  class='btn btn-sm bg-success-light'>
        Valider 
    </a>
</div>
    </td>
