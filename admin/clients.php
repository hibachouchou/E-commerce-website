...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM visiteur");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM visiteur LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
    header("location:clients.php?page=1");
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active"><a href="clients.php?page=1"><i class="fas fa-users-cog"></i> <span>Clients</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Liste des visiteurs</h3>
                            <ul class="breadcrumb">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-hover table-center mb-0" >
                                            ...
                                            <?php
foreach($resultspg as $index=> $client){
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='clients.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='clients.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='clients.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='clients.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
