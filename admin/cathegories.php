...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM categorie");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM categorie LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
    header("location:cathegories.php?page=1");
}
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active" ><a href="cathegories.php?page=1"><i class="fas fa-tag"></i> <span>categories</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Liste des categories</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-sm-5 col">
								<a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-success float-right mt-2">Ajouter categorie</a>
							</div>
                    </div>
                </div>
					<!-- /Page Header -->
...
?>
                                            ...
                                            <?php
foreach($resultspg as $index=> $cath){
  ...
  echo"
    <td class='text-right'>
    <div class='actions'>
        <a class='btn btn-sm bg-primary-light' data-toggle='modal' data-target='#edit_specialities_details".$cath['id_cat']."'>
            <i class='fe fe-pencil'></i> Modifier
        </a>
        <a  data-toggle='modal' href='#delete_modal".$cath['id_cat']."'  class='btn btn-sm bg-danger-light'>
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='cathegories.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='cathegories.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='cathegories.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='cathegories.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
...
?>
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control"  name="nomc">
  </div>

<div class="mb-3">
  <label  class="form-label">Description :</label>
  <textarea  class="form-control"  rows="5" name="descc"></textarea>
</div>
<div class="mb-3">
  <label  class="form-label">Famille :</label>
  <select required name="fam"   class="form-control">
...
foreach($cathegorie as $index=>$cath){?>
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $cath['id_cat'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
...
<div class="mb-3">
    <input type="hidden" class="form-control"   value="<?php echo $cath['id_cat'] ;?>" name="idcm">
    
  </div>
  <div class="mb-3">
    <label  class="form-label">NOM:</label>
    <input type="text" class="form-control"  value="<?php echo $cath['nom_cat'] ;?>" name="nomcm">
  </div>
 
<div class="mb-3">
  <label  class="form-label">DESCRIPTION:</label>
  <textarea class="form-control"  rows="5"   name="desccm"><?php echo $cath['desc_cat'] ;?></textarea>
</div>
<div class="mb-3">
  <label  class="form-label">FAMILLE:</label>
...
foreach($cathegorie as $index=>$cath){?>
			<!-- Delete Modal -->
			<div class="modal fade" id="delete_modal<?php echo  $cath['id_cat']; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<p class="mb-4">Voulez vous vraiment supprimer cette categorie ?</p>
								<a href='../catheg/supp.php?id=<?php echo  $cath['id_cat']; ?>'><button type="button" class="btn btn-danger" >Supprimer </button></a>
