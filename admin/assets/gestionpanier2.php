...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM panier");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM panier LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
    header("location:gestionpanier2.php?page=1");
}
?>
<!DOCTYPE html>
<html lang="fr">
