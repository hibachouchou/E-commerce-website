        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
							<div class="col">
								<h3 class="page-title">Details panier </h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">ACCUEIL</a></li>
									<li class="breadcrumb-item active">Details panier</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="profile-menu">
								<ul class="nav nav-tabs nav-tabs-solid">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab" href="#per_details_tab">Afficher Details panier <i class='fas fa-shopping-cart'></i></a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#password_tab">Afficher les Commandes <i class="fas fa-shopping-bag"></i></a>
									</li>
								</ul>
							</div>	
							<div class="tab-content profile-tab-cont">
								...
								<div class="tab-pane fade show active" id="per_details_tab">
									...
									<!-- Personal Details -->
                                    <h5 class="card-title">Details Panier:</h5>
									<div class="row">
										<div class="col-lg-12">
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0 mb-sm-3">Num Cin :</p>
                       ...
                       ?></p>
													...
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0 mb-sm-3">Province :</p>
														<p class="col-sm-10"><?php
                       foreach($adresse as $index=>$adr){
                        if($pan['id_panier']==$adr['panier']){
                       echo $adr['province']; 
                       ...
                       ?></p>
													...
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0 mb-sm-3">Delegation :</p>
														<p class="col-sm-10"><?php
                       foreach($adresse as $index=>$adr){
                        if($pan['id_panier']==$adr['panier']){
                       echo $adr['delegation']; 
                       ...
                       ?><br>
                                                    ...
                                                    <div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0">Code postale :</p>
														<p class="col-sm-10 mb-0"><?php
                       foreach($adresse as $index=>$adr){
                        if($pan['id_panier']==$adr['panier']){
