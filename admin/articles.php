        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active"><a href="articles.php?page=1"> <i class="fas fa-book-reader"></i> <span>Articles</span></a></li>
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-5 col">
								<a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-success float-right mt-2">Ajouter article</a>
							</div>
                    </div>
                </div>
					<!-- /Page Header -->
...
if  (isset($_GET['delete']) && $_GET['delete']=="ok"){
  ...
  Article supprimee avec success 
  </div>";
}
?>
<?php 
...
?>
                                            ...
                                            <?php
foreach($resultspg as $art){

    echo " <tr>
    <th scope='row'>".$art['id_art']."</th>
    <td>".$art['titre']."</td>
    <td><img src="."../img/".$art['image_art']." width='100px;' ></td>
    <td>".$art['contenu']."</td>
 

    <td class='text-right'>
    <div class='actions'>
        <a class='btn btn-sm bg-primary-light' data-toggle='modal' data-target='#edit_specialities_details".$art['id_art']."'>
            <i class='fe fe-pencil'></i> Modifier
        </a>
        <a  data-toggle='modal' href='#delete_modal".$art['id_art']."'  class='btn btn-sm bg-danger-light'>
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='articles.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='articles.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='articles.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='articles.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
			...
			<div class="modal fade" id="Add_Specialities_details" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<form id="f1" action="../articles/ajout.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
    <label  class="form-label">ID:</label>
    <input type="number" class="form-control"  name="idart">
    
  </div>
  <div class="mb-3">
    <label  class="form-label">TITRE:</label>
    <input type="text" class="form-control" required name="titart">
  </div>
  <div class="mb-3">
    <label  class="form-label">IMAGE:</label>
    <input type="file" class="form-control" required  name="imgart">
  </div>
<div class="mb-3">
  <label  class="form-label">CONTENU:</label>
  <textarea class="form-control"  required rows="5" name="ctart"></textarea>
</div>
...
foreach($article as $art){?>
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $art['id_art'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body">
                        <form id="f1" action="../articles/modif.php" method="POST" enctype="multipart/form-data">
<div class="mb-3">
    <input type="hidden" class="form-control"  value="<?php echo $art['id_art'] ;?>" name="idartm">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">TITRE:</label>
    <input type="text" required class="form-control"  value="<?php echo $art['titre'] ;?>" name="titrem">
  </div>
 
<div class="mb-3">
  <label  class="form-label">CONTENU:</label>
  <textarea  required class="form-control"  rows="5"   name="ctnartm"><?php echo $art['contenu'] ;?></textarea>
</div>
<div class="mb-3">
    <label  class="form-label">IMG:</label>
    <input type="file" required class="form-control" value="<?php echo $art['image_art'] ;?>" name="imgartm">
  </div>
...
foreach($article as $art){?>
			<!-- Delete Modal -->
			<div class="modal fade" id="delete_modal<?php echo $art['id_art'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<p class="mb-4">Voulez vous vraiment supprimer cet article ?</p>
								<a href='../articles/supp.php?id=<?php echo  $art['id_art']; ?>'><button type="button" class="btn btn-danger" >Supprimer </button></a>
