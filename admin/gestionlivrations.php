...
$page=filter_var($_GET['page'],FILTER_SANITIZE_NUMBER_INT);
$nbrresults=$conn->prepare("SELECT * FROM panier where etat=1");
$nbrresults->execute();
...
$resultspg=$conn->prepare("SELECT * FROM panier where etat=1 LIMIT ".$results."  OFFSET  ".($page-1)* $results);
$resultspg->execute();
}else{
    header("location:gestionpanier.php?page=1");
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<head>
        ...
        <title>Gestion des livrations</title>
    ...
    <body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="active"><a href="gestionlivrations.php?page=1"><i class="fas fa-shipping-fast"></i> <span>Livraisons</span></a></li>
        ...
        <!-- /Sidebar -->
            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                        <div class="col">
                            <h3 class="page-title">Liste des paniers livrees</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashbord.php">ACCUEIL</a></li>
                                <li class="breadcrumb-item active">Liste des paniers livrees</li>
                            </ul>
                        </div>
                </div>
					<!-- /Page Header -->
...
foreach($resultspg as $pan){
 ...
 echo "
    ...
    <td class='text-right'>
    <div class='actions'>
        <a class='btn btn-sm bg-info-light' href='details.php?id=".$pan['id_panier']."'>
        <i class='fas fa-eye'></i> Afficher les details 
        </a>
</div>
    </td>
  </tr>
...
<div class="pge">
  ...
  if($page>1){echo"  <li class='page-item '>
    <a class='page-link' href='gestionpanier.php?page=".($page-1)."'>Precidant</a></li>";}else{
 ...
 for($count=1;$count<=$totalpages;$count++){
   //-8 la page active
if($page==$count){
echo "   <li class='page-item active'><a class='page-link'  href='gestionpanier.php?page=".$count."'>".$count."</a></li>
";
}else{
echo "  
<li class='page-item'><a class='page-link' href='gestionpanier.php?page=".$count."'>".$count."</a></li> 
";
 ...
 <a class='page-link' href='gestionpanier.php?page=".($page+1)."'>Suivant</a>
</li>";      ?>
 </ul>
 </nav>
 </div>
...
foreach($panier as $pan){?>
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_specialities_details<?php echo $pan['id_panier'] ; ?>" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Details panier</h5>
                       ...
                       foreach($adresse as $index=>$adr){
                        if($pan['id_panier']==$adr['panier']){
                       echo $adr['code postal']; 
                      }
                    }
                       
                       ?></h5>

<a href='../details.php?id=<?php echo $pan['id_panier'];?>'> <button type='button' class='btn btn-info' >AFFICHER DETAILS COMMANDE</button></a>
						</div>
					</div>
				</div>
			</div>
					...
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								<h4 class="modal-title">Valider panier</h4>
								<p class="mb-4">Voulez vous vraiment valider cette panier ?</p>
								<a href='../validercommande.php?id=<?php echo  $pan['id_panier']; ?>'><button type="button" class="btn btn-success" >Valider </button></a>
