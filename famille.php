  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="staticBackdropLabel">AJOUTER FAMILLE</h4>
...
<div class="mb-3">
  ...
  <textarea class="form-control"  id="exampleFormControlTextarea1" rows="5" name="descf"></textarea>
</div>
...
<!-- Modal Modif -->
<section>
<div class="modal fade" id="editmodal<?php echo $fam['id'] ; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="staticBackdropLabel">MODIFIER FAMILLE</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <section>
<form id="f1" action="fam/modif.php" method="POST">
<div class="mb-3">
    <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $fam['id'] ;?>" name="idfm">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">NOM:</label>
    <input type="text" required class="form-control" id="exampleInputPassword1" value="<?php echo $fam['nom'] ;?>" name="nomfm">
  </div>
 
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">DESCRIPTION:</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"   name="descfm"><?php echo $fam['desc'] ;?></textarea>
</div>
<!--section id="cssstyle">
  <h4>ESPACE DEVELOPPEUR </h4>
  <h5>(NE TOUCHER PAS!)</h5>
...
foreach($famille as $fam){
    ...
    <td>".$fam['desc']."</td>
    <td>
        <button type='button' class='btn btn-info' data-bs-toggle='modal' data-bs-target='#editmodal".$fam['id']."' >MODIFIER</button><a href='fam/supp.php?id=".$fam['id']."' onclick='return popUpDelete()'><button type='button' class='btn btn-danger'>SUPPRIMER</button></a>
    </td>
  </tr>
  <tr>";
}
...
return confirm("Voulez vous vraiment supprimer cette famille!");
  }
</script>
